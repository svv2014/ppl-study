...
**PPL-A Foundation:** PPL-A lessons GK-002 (four-forces), GK-012 (stalls-spins), and GK-013 (load-factor) cover fundamental aerodynamics. This CPL-A lesson extends to: static vs. dynamic stability, longitudinal/lateral/directional stability, the critical engine concept in multi-engine aircraft (Vmca), V-speed definitions required at CPL level (Vmc, Vsse, Vxse, Vyse), and introductory Mach effects (Mach tuck, coffin corner) relevant for pressurized aircraft awareness.
